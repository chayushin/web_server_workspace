...
create table attatchment (
    ...
    reg_date date default sysdate,
    constraints pk_attatchment_id primary key(id),
    constraints fk_attatchment_board_id foreign key(board_id) references board(id) on delete cascade
);

create sequence seq_attatchment_id;
